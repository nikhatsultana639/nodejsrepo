...
import { home, getTodayDate, getMonthsName,getIPeople } from 'C:/Users/NSulthana.CORP/OneDrive - Genzeon Corporation/Documents/nodejs/nodejsrepo/source/controllers/controller.js';
// set up the routing
const routes = (app) => {
    // home page
    app.route('/')
